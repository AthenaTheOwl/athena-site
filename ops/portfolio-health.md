...
|---|---|---|---|---|
| chip-supply-chain-map | src/data/nodes.csv | 48 | 180 | ✅ |
| supplier-risk-rag-agent | reports/baseline_eval_report.html | 74 | 90 | ✅ |
...
| sports-prediction-os | 7 | ✅ |
| dispatch-optimizer | 7 | ✅ |
| LLM-evaluation-framework | 7 | ✅ |
